...
```{r,fig.align='center',fig.cap=("Figure 2: Make vs Sticker Plot")}
...
The plot above shows Car Make vs Sticker. Below is an ANOVA anylysis of the same information.
...
```{r,fig.align='center',fig.cap=("Color vs Sticker Plot")}
...
```
This plot compared car color with having a sticker or not. In my finding red cars were the most likely to have stickers.Below is an ANOVa analysis of that information.
...
I didn't find any conclusive data that one's type of car correlates with them having a sticker. But from the data I collected Vans are much more like to have stickers on them then the other types. I think for more conslusive data I would need to see 25 vans,sedans, trucks,SuV's, etc and compare how many of each had stickers on them.
