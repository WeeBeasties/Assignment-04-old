...
Cars <- read.csv("Cars coding.csv")
names(Cars) <- c("Type", "Make", "Color", "Sticker")
...
table <- as_tibble(Cars) %>% group_by(Type,Sticker) %>% summarize(Number = n()) %>% arrange(desc(Number))
...
ggplot(Cars, aes(x=Type, y=Sticker)) + geom_bar(position = "dodge", stat = "summary", fun="mean", fill = "dodgerblue3")
...
ggplot(Cars, aes(x=Make, y=Sticker)) + geom_bar(position = "dodge", stat = "summary", fun="mean", fill = "magenta4")
...
ggplot(Cars, aes(x=Color, y=Sticker)) + geom_bar(position = "dodge", stat = "summary", fun="mean", fill = "olivedrab4")
