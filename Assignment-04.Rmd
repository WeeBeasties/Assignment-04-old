...
## Procedure
100 cars were surveyed at random at a walmart parking lot on 7/7/20 at 5:50pm. Their make, type, color, and absense or presence of a sticker was recorded. This data was encoded into "car_observations.csv."
...
```
Te ANOVA test was used to determine whether or not there is any significant difference between these two variables; sticker frequency and type of car. 
...
```{r sticker compared to make, echo = FALSE, message = FALSE, fig.cap = "**Figure 2:** Sticker Presence and Type of Car", fig.align = "left", out.width = 683}
...
car_observations %>%
	...
	ggplot() + geom_bar(aes(x = make, y = SuperFreq), stat = "summary", fun = "mean") + ylim(-0, 100) + labs(x = "Make of Car", y = "Sticker Frequency (%)")
