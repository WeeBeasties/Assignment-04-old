...
```
This plot compared car color with having a sticker or not. In my finding white cars were the most likely to have stickers.Below is an ANOVa analysis of that information.
